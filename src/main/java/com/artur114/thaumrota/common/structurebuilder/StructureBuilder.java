package com.artur114.thaumrota.common.structurebuilder;

import com.artur114.thaumrota.common.blockprotect.BlockProtectHandler;
import com.artur114.thaumrota.common.structurebuilder.interf.IBuildProperties;
import com.artur114.thaumrota.common.structurebuilder.interf.IStructureBuilder;
...
public class StructureBuilder implements IStructureBuilder {
    ...
    private NBTTagCompound readStructureAsName(String structureName) {
        InputStream inputstream = MinecraftServer.class.getResourceAsStream("/assets/" + ThaumicRotA.MODID + "/structures/" + structureName + ".nbt");
        try {
