...
public class ModelAncientPiston extends ModelBase {
	...
	public ModelAncientPiston() {
		...
		piston.cubeList.add(new ModelBox(piston, 0, 19, -10.0F, -8.0F, -5.0F, 10, 2, 10, 0.0F, false));
		piston.cubeList.add(new ModelBox(piston, 0, 32, -9.0F, -6.0F, -4.0F, 8, 16, 8, 0.0F, false));

		base = new ModelRenderer(this);
		base.setRotationPoint(0.0F, 24.0F, 0.0F);
		base.cubeList.add(new ModelBox(base, 0, 0, -8.0F, -2.0F, -8.0F, 16, 2, 16, 0.0F, false));
		base.cubeList.add(new ModelBox(base, 62, 1, 4.0F, -5.0F, -6.0F, 2, 1, 12, 0.0F, false));
		base.cubeList.add(new ModelBox(base, 41, 19, -4.0F, -5.0F, -6.0F, 8, 1, 2, 0.0F, false));
		base.cubeList.add(new ModelBox(base, 41, 23, -4.0F, -5.0F, 4.0F, 8, 1, 2, 0.0F, false));
		base.cubeList.add(new ModelBox(base, 62, 19, -6.0F, -5.0F, -6.0F, 2, 1, 12, 0.0F, false));

		cube_r1 = new ModelRenderer(this);
		cube_r1.setRotationPoint(7.0F, 0.0F, 0.0F);
		base.addChild(cube_r1);
		setRotationAngle(cube_r1, 0.0F, 0.0F, -0.48F);
		cube_r1.cubeList.add(new ModelBox(cube_r1, 33, 32, -1.0F, -4.0F, -6.0F, 2, 3, 12, 0.0F, false));

		cube_r2 = new ModelRenderer(this);
		cube_r2.setRotationPoint(-7.0F, 0.0F, 0.0F);
		base.addChild(cube_r2);
		setRotationAngle(cube_r2, 0.0F, 0.0F, 0.48F);
		cube_r2.cubeList.add(new ModelBox(cube_r2, 33, 48, -1.0F, -4.0F, -6.0F, 2, 3, 12, 0.0F, false));

		cube_r3 = new ModelRenderer(this);
		cube_r3.setRotationPoint(0.0F, 0.0F, -7.0F);
		base.addChild(cube_r3);
		setRotationAngle(cube_r3, -0.48F, 0.0F, 0.0F);
		cube_r3.cubeList.add(new ModelBox(cube_r3, 62, 33, -6.0F, -4.0F, -1.0F, 12, 3, 2, 0.0F, false));

		cube_r4 = new ModelRenderer(this);
		cube_r4.setRotationPoint(0.0F, 0.0F, 7.0F);
		base.addChild(cube_r4);
		setRotationAngle(cube_r4, 0.48F, 0.0F, 0.0F);
		cube_r4.cubeList.add(new ModelBox(cube_r4, 62, 39, -6.0F, -4.0F, -1.0F, 12, 3, 2, 0.0F, false));
	}
