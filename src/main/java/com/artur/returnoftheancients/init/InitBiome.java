...
public class InitBiome {
    ...
    public static final Biome TAINT_MOUNTAINS_EXTREME = new BiomeTaint("taint_mountains_extreme_r", new Biome.BiomeProperties("Taint Extreme Rocks").setWaterColor(0x310042).setBaseHeight(1.6F).setRainfall(1.0F).setHeightVariation(0.8F), EBiome.TAINT, BiomeTaint.TaintType.HILLS);
