...
import com.artur114.thaumrota.common.capabilities.GenericCapProviderS;
...
public class ServerBlockProtectManager {
    ...
    public void attachCapabilitiesEventChunk(AttachCapabilitiesEvent<Chunk> e) {
        e.addCapability(new ResourceLocation(ThaumicRotA.MODID, "protected_chunk"), new GenericCapProviderS<>(new ServerProtectedChunk(e.getObject().getPos(), e.getObject().getWorld().provider.getDimension()), InitCapabilities.PROTECTED_CHUNK));
    }
