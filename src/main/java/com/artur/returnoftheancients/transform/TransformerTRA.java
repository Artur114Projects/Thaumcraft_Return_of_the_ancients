    ...
    public byte[] transform(String name, String transformedName, byte[] basicClass) {
        for (ITransformer transformer : TRANSFORMERS) {
            if (transformer.isTarget(transformedName)) {
                try {
//                    System.out.println(FMLDeobfuscatingRemapper.INSTANCE.mapFieldName(FMLDeobfuscatingRemapper.INSTANCE.unmap("net/minecraft/client/renderer/entity/RenderLivingBase"), "field_177097_h", "Ljava/util/List;")); // field_177097_h
