package com.artur114.thaumrota.common.worldstate.blockprotect.server;

import com.artur114.thaumrota.common.worldstate.blockprotect.BlockProtectEventsHandler;
...
import com.artur114.thaumrota.common.worldstate.blockprotect.ProtectedChunk;
import com.artur114.thaumrota.main.ThaumRotA;
import com.artur114.thaumrota.common.network.ClientPacketSyncProtectedChunk;
...
public class ServerProtectedChunk extends ProtectedChunk implements IServerProtectedChunk {
    ...
    public void syncToClient(EntityPlayerMP clientIn) {
        if (!this.isEmpty() && clientIn != null) {
            ThaumRotA.NETWORK.sendTo(new ClientPacketSyncProtectedChunk(this.dimension, this.pos, this.serializeNBT()), clientIn);
        }
    }
