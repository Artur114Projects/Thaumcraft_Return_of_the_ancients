...
public class InitParticleSprite {
    ...
    public static final ParticleAtlasSprite PARTICLE_BLOCK_PROTECT_0 = new ParticleAtlasSprite(EnumAsset.TEXTURES_TC_MODELS, ParticleAtlasSprite.genNumberedNames("hemis", 1, 15));
    public static final ParticleAtlasSprite PARTICLE_BLOCK_PROTECT_1 = new ParticleAtlasSprite(EnumAsset.TEXTURES_TC_MODELS, ParticleAtlasSprite.genNumberedNames("ripple", 1, 15));
}
