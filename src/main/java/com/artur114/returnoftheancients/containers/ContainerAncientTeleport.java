package com.artur114.returnoftheancients.containers;

import com.artur114.returnoftheancients.containers.slots.SlotItemHandlerAspectInput;
import com.artur114.returnoftheancients.containers.slots.SlotItemHandlerOutput;
...
public class ContainerAncientTeleport extends ContainerWithPages {
    ...
    public void addListener(@NotNull IContainerListener listener) {
        ...
        tile.energyContainerHandler.addListener(listener, this);
    ...
    public void detectAndSendChanges() {
        ...
        for (int i = 0; i != listeners.size(); i++) {
            ...
            tile.energyContainerHandler.detectAndSendChanges(icontainerlistener, this);
    ...
    public void updateProgressBar(int id, int data) {
        ...
        tile.energyContainerHandler.updateDataOnClient(id, data);
        if (id >= 100) {
