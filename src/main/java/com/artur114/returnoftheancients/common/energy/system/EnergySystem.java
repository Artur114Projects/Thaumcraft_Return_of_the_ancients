...
import com.artur114.returnoftheancients.common.util.multitread.AsyncCompileManager;
...
public class EnergySystem {
    ...
    private static class EnergyWaysMapCompiler implements Supplier<Map<OutputInput, EnergyWay>> {
        ...
        private void fillMap() {
            ...
            this.map = set.stream().collect(Collectors.toMap(ITileEnergy::pos, Function.identity()));
        }
