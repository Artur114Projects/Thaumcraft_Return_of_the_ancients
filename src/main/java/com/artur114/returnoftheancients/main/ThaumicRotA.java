...
import com.artur114.returnoftheancients.common.proxy.CommonProxy;
...
public class ThaumicRotA {
    ...
    public static final IRegisterBus REGISTER_BUS = new BananaRegisterBus();
    @Instance public static ThaumicRotA INSTANCE;
