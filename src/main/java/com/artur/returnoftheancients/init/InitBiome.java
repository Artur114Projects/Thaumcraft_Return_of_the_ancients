...
public class InitBiome {
    ...
    public static final Biome TAINT_EXTREME_MOUNTAINS = new BiomeTaint("taint_mountains_extreme_r", new Biome.BiomeProperties("Taint Extreme Rocks").setWaterColor(0x310042).setBaseHeight(1.6F).setRainfall(1.0F).setHeightVariation(0.8F).setTemperature(0.22F), EBiome.TAINT, BiomeTaint.TaintType.HILLS);
    public static final Biome TAINT_MOUNTAINS = new BiomeTaint("taint_mountains_r", new Biome.BiomeProperties("Taint Rocks").setWaterColor(0x310042).setBaseHeight(1.0F).setRainfall(1.0F).setHeightVariation(0.5F).setTemperature(0.22F), EBiome.TAINT, BiomeTaint.TaintType.HILLS);
