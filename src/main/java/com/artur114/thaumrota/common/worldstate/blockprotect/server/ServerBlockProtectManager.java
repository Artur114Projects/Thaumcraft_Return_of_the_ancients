...
public class ServerBlockProtectManager {
    ...
    public void attachCapabilitiesEventChunk(AttachCapabilitiesEvent<Chunk> e) {
        e.addCapability(new ResourceLocation(ThaumRotA.MODID, "protected_chunk"), new BananaCapProv<>(new ServerProtectedChunk(e.getObject().getPos(), e.getObject().getWorld().provider.getDimension()), InitCapabilities.PROTECTED_CHUNK));
    }
