...
import com.artur114.thaumrota.common.network.ClientPacketPlayerNBTData;
...
public class MiscHandler {
    ...
    public static void setStartUpNBT(EntityPlayerMP playerMP, boolean data) {
        ...
        ThaumicRotA.NETWORK.sendTo(new ClientPacketPlayerNBTData(MiscHandler.createPlayerDataPacketTag("startUpNBT", data)), playerMP);
    }
    ...
    public static void setTeleportingToHomeNBT(EntityPlayerMP playerMP, boolean data) {
        ...
        ThaumicRotA.NETWORK.sendTo(new ClientPacketPlayerNBTData(MiscHandler.createPlayerDataPacketTag(AncientPortal.tpToHomeNBT, data)), playerMP);
    }
    ...
    public static void setLoadingGuiState(EntityPlayerMP playerMP, boolean state, boolean isTeam) {
        ...
        ThaumicRotA.NETWORK.sendTo(new ClientPacketMisc(nbt), playerMP);
    }
...
//        MainR.NETWORK.sendTo(new ClientPacketMisc(nbt), playerMP);
    ...
    public static void injectNamesOnClient(List<String> names, EntityPlayerMP player) {
        ...
        ThaumicRotA.NETWORK.sendTo(new ClientPacketMisc(nbt), player);
    }
    ...
    public static void sendAllMessageStringNoTitle(String message) {
        ...
        ThaumicRotA.NETWORK.sendToAll(new ClientPacketMisc(nbt));
    }
...
//        nbt.setLong("soundPos", pos.toLong());
        ThaumicRotA.NETWORK.sendToAllAround(new ClientPacketMisc(nbt), new NetworkRegistry.TargetPoint(dimension, pos.getX(), pos.getY(), pos.getZ(), range));
    }

    public static void playSoundToTargetPoint(SoundTRA sound, int dimension, double x, double y, double z, double range) {
        NBTTagCompound nbt = new NBTTagCompound();
        nbt.setString("playSound", sound.NAME);
        ThaumicRotA.NETWORK.sendToAllAround(new ClientPacketMisc(nbt), new NetworkRegistry.TargetPoint(dimension, x, y, z, range));
    }
