...
public class BuildRequest implements IBuildProperties {
    ...
    protected BiFunction<IBlockState, BlockPos, Boolean> blockProtectHook = null;
    protected BiFunction<TileEntity, NBTTagCompound, TileEntity> tileEntityHook = null;
    ...
    public BuildRequest addBlockProtectHook(BiFunction<IBlockState, BlockPos, Boolean> hook) {
    ...
    public BuildRequest addTileEntityHook(BiFunction<TileEntity, NBTTagCompound, TileEntity> hook) {
