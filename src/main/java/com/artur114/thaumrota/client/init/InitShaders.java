...
public class InitShaders {
    ...
    public static final ShaderBuilder TEST_SHADER = new ShaderBuilder(() -> new ShaderProgram().addFragment(devPath.resolve("test_shader.frag")).addVertex(EnumAsset.SHADERS.path("texture_color.vert")).compile());
