package com.artur114.returnoftheancients.common.blockprotect.server;

import com.artur114.returnoftheancients.common.blockprotect.BlockProtectEventsHandler;
...
import com.artur114.returnoftheancients.common.blockprotect.ProtectedChunk;
import com.artur114.returnoftheancients.main.ThaumicRotA;
import com.artur114.returnoftheancients.common.network.ClientPacketSyncProtectedChunk;
...
public class ServerProtectedChunk extends ProtectedChunk implements IServerProtectedChunk {
    ...
    public void syncToClient(EntityPlayerMP clientIn) {
        if (!this.isEmpty() && clientIn != null) {
            ThaumicRotA.NETWORK.sendTo(new ClientPacketSyncProtectedChunk(this.dimension, this.pos, this.serializeNBT()), clientIn);
        }
    }
