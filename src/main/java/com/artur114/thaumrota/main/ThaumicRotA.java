...
@Mod(modid = ThaumicRotA.MODID, useMetadata = true)
public class ThaumicRotA {
    public static final CreativeTabs ROTA_CREATIVE_TAB = new CreativeTabRotA("thaumrota_tab");
    ...
    public static final McModInfo METADATA = McModInfo.load("thaumrota").orElse(null);
