...
import com.artur114.thaumrota.client.render.tile.TileEntityAncientDoor4X3Render;
...
public class BlockAncientDoor4X3 extends BaseBlockTile<TileEntityAncientDoor4X3> {
    ...
    protected @Nullable TileEntitySpecialRenderer<TileEntityAncientDoor4X3> createTileRender() {
        return new TileEntityAncientDoor4X3Render();
    }
    ...
    @Override
    public Class<TileEntityAncientDoor4X3> tileClass() {
