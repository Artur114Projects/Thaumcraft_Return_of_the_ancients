...
import static net.minecraft.client.renderer.OpenGlHelper.GL_DEPTH_ATTACHMENT;
...
public class ShaderProgram {
    ...
    public static void renderFullScreen(ShaderProgram shaderProgram, Runnable onShaderEnabled) {  // TODO: 02.05.2025 Rewrite!
        ...
        GlStateManager.enableTexture2D();
        GL11.glBindTexture(GL11.GL_TEXTURE_2D, HeatShader.framebuffer.framebufferTexture);
        shaderProgram.uniform("shaderArea", 2);
    ...
    public static void createDepthCopyFBO() {
        ...
        // Фильтрация – только NEAREST, иначе значения испортятся
        GlStateManager.glTexParameteri(GL11.GL_TEXTURE_2D, GL11.GL_TEXTURE_MIN_FILTER, GL11.GL_NEAREST);
        GlStateManager.glTexParameteri(GL11.GL_TEXTURE_2D, GL11.GL_TEXTURE_MAG_FILTER, GL11.GL_NEAREST);
        // CLAMP, чтобы не было артефактов по краям
        GlStateManager.glTexParameteri(GL11.GL_TEXTURE_2D, GL11.GL_TEXTURE_WRAP_S, GL11.GL_CLAMP);
        GlStateManager.glTexParameteri(GL11.GL_TEXTURE_2D, GL11.GL_TEXTURE_WRAP_T, GL11.GL_CLAMP);
        GlStateManager.bindTexture(0);

        // Генерируем FBO и прикрепляем к нему нашу depth-текстуру
        ...
        // У нашего FBO нет цветового буфера – это нормально, надо явно это указать
        ...
        // Обязательно возвращаем привязку к основному FBO игры
