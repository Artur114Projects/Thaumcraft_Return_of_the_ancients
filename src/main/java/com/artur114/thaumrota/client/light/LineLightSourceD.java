...
public class LineLightSourceD implements ILightSource {
    private Vec3DM from;
    private Vec3DM to;
    private Color color;
    ...
    public LineLightSourceD(Vec3DM from, Vec3DM to, Color color, float brightness, float range, float heat) {
    ...
    public void setFrom(Vec3DM from) {
        this.from = from;
    }

    public void setTo(Vec3DM to) {
        this.to = to;
    }
    ...
    public void writeToBuff(int pass, FloatBuffer buffer) {
        switch (pass) {
            ...
            case 1:
                ...
                break;
            case 2:
                buffer.put((float) (this.from.x() - Particle.interpPosX));
                buffer.put((float) (this.from.y() - Particle.interpPosY));
                buffer.put((float) (this.from.z() - Particle.interpPosZ));
                break;
            case 3:
                buffer.put((float) (this.to.x() - Particle.interpPosX));
                buffer.put((float) (this.to.y() - Particle.interpPosY));
                buffer.put((float) (this.to.z() - Particle.interpPosZ));
                break;
            case 4:
                buffer.put((float) (Math.min(this.from.x(), this.to.x()) - (this.range * 1.8) - Particle.interpPosX));
                buffer.put((float) (Math.min(this.from.y(), this.to.y()) - (this.range * 1.8) - Particle.interpPosY));
                buffer.put((float) (Math.min(this.from.z(), this.to.z()) - (this.range * 1.8) - Particle.interpPosZ));
                break;
            case 5:
                buffer.put((float) (Math.max(this.from.x(), this.to.x()) + (this.range * 1.8) - Particle.interpPosX));
                buffer.put((float) (Math.max(this.from.y(), this.to.y()) + (this.range * 1.8) - Particle.interpPosY));
                buffer.put((float) (Math.max(this.from.z(), this.to.z()) + (this.range * 1.8) - Particle.interpPosZ));
                break;
            case 6:
